<footer class="page_footer cs main_color2 table_section section_padding_50 columns_padding_0">
	...
	<script src="{{ URL::asset('asstes_theme/js/compressed.js') }}"></script>
	<script src="{{ URL::asset('asstes_theme/js/main.js') }}"></script>
	<script src="{{ URL::asset('asstes_theme/js/logo.js') }}"></script>
