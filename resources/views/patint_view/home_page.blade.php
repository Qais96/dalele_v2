@include('theme_layout.slider_one')
...
"><span>عن 
          ...
          <p>تسعى منصة دليلي إلى نشر المعرفة التي امتلكها المشرفون التربويون العاملون معها إلى مستفيدين آخرين عن طريق تفعيل برامج نشاطات هادفة تشمل قطاعات أخرى من المجتمع تعرضوا للظروف القاسية نفسها.

</p>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="item"> <span class="icon feature_box_col_one">	<img src="{{ URL::asset('asstes_theme/images/service-icons/relationship.png') }}" alt="" /></span>
            <h6>حصص توجيه جمعي</h6>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="item"> <span class="icon feature_box_col_two">		<img src="{{ URL::asset('asstes_theme/images/service-icons/mental.png') }}" alt="" /></span>
            <h6>حصص توعوية</h6>
          
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="item"> <span class="icon feature_box_col_three">	<img src="{{ URL::asset('asstes_theme/images/service-icons/conflicting.png') }}" alt="" /></span>
            <h6>جلسات دعم نفسي</h6>
          
          </div>
        </div>
		<div class="col-lg-3 col-sm-6">
          <div class="item"> <span class="icon feature_box_col_three">	<img src="{{ URL::asset('asstes_theme/images/service-icons/feelings.png') }}" alt="" /></span>
            <h6>استشارات نفسية</h6>
...
<section id="services" class="ls section_padding_top_130 section_padding_bottom_100">
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
							<h2 class="section_header with_icon">عن دليلي</h2>
							<p>
							تسعى منصة دليلي إلى نشر المعرفة التي امتلكها المشرفون التربويون العاملون معها إلى مستفيدين آخرين عن طريق تفعيل برامج نشاطات هادفة تشمل قطاعات أخرى من المجتمع تعرضوا للظروف القاسية نفسها.							</p>
						</div>
					</div>
					<div class="row columns_padding_0 columns_margin_0 fontsize_16">
						<div class="col-md-3 col-sm-6">
							<div class="with_padding text-center teaser hover_shadow">
								...
								<img src="{{ URL::asset('asstes_theme/images/service-icons/relationship.png') }}" alt="" />
								<h4>
									<a href="service-single.html">استشارات نفسية</a>
								</h4>
						...
						<div class="col-md-3 col-sm-6">
							<div class="with_padding text-center teaser hover_shadow">
                            								<img src="{{ URL::asset('asstes_theme/images/service-icons/mental.png') }}" alt="" />
								<h4>
									<a href="service-single.html">جلسات دعم نفسي</a>
								</h4>
						...
						<div class="col-md-3 col-sm-6 clear-sm">
							<div class="with_padding text-center teaser hover_shadow">
								<img src="{{ URL::asset('asstes_theme/images/service-icons/feelings.png') }}" alt="" />
								<h4>
									<a href="service-single.html">حصص توعوية</a>
								</h4>
						...
						<div class="col-md-3 col-sm-6">
							<div class="with_padding text-center teaser hover_shadow">
								<img src="{{ URL::asset('asstes_theme/images/service-icons/conflicting.png') }}" alt="" />
								<h4>
									<a href="service-single.html">حصص توجيه جمعي</a>
								</h4>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-6 col-md-push-6 text-center">
							...
							<img src="{{ URL::asset('asstes_theme/images/signature.png') }}" alt="" />
						</div>
						<div class="col-md-6 col-md-pull-6 text-center bottommargin_0">
							<img src="{{ URL::asset('asstes_theme/images/person.png') }}" alt="" class="top-overlap" />
						</div>
					</div>
				</div>
			</section>
					...
					<div class="row">
						<div class="col-md-4 text-center">
							<article class="vertical-item content-padding post format-standard with_shadow">
								...
								<div class="item-media entry-thumbnail">
									<img src="{{ URL::asset('asstes_theme/images/blog_post1.jpg') }}" alt="">
								</div>
						...
						<div class="col-md-4 text-center">
							<article class="vertical-item content-padding post format-standard with_shadow">
								...
								<div class="item-media entry-thumbnail">
									<img src="{{ URL::asset('asstes_theme/images/blog_post2.jpg') }}" alt="">
								</div>
						...
						<div class="col-md-4 text-center">
							<article class="vertical-item content-padding post format-standard with_shadow">
								...
								<div class="item-media entry-thumbnail">
									<img src="{{ URL::asset('asstes_theme/images/blog_post3.jpg') }}" alt="">
								</div>
						...
						<div class="col-md-6">
							...
							<div class="tab-content padding_0">
								...
								<div class="tab-pane fade in active" id="tab1">
									<div class="embed-responsive embed-responsive-16by9">
										<a href="//player.vimeo.com/video/1084537" class="embed-placeholder">
											<img src="{{ URL::asset('asstes_theme/images/video_tab1.jpg') }}" alt="">
										</a>
									</div>
								</div>
								...
								<div class="tab-pane fade" id="tab2">
									<div class="embed-responsive embed-responsive-16by9">
										<a href="//player.vimeo.com/video/1084537" class="embed-placeholder">
											<img src="{{ URL::asset('asstes_theme/images/video_tab2.jpg') }}" alt="">
										</a>
									</div>
								</div>
								...
								<div class="tab-pane fade" id="tab3">
									<div class="embed-responsive embed-responsive-16by9">
										<a href="//player.vimeo.com/video/1084537" class="embed-placeholder">
											<img src="{{ URL::asset('asstes_theme/images/video_tab3.jpg') }}" alt="">
										</a>
									</div>
								</div>
							</div>
			...
			<div  class="test_one" style="    background-color: white;">
				
		  <section class=" container">
            <div class="center-div">
               <h2>5) وفرص تدريب لخريجي التخصصات الإنسانية
</h2>
            ...
            <div id="choices">
                ...
                <div id="right-top">
                    <div id="right-top-circle">
                        <img src="https://i.ibb.co/qgKNr59/backup.png"alt="backup"/>
                    </div>

                    <div id="right-top-text">
                        <h3>2).تعزيز مبدأ التعلم عن بعد لمواكبة عصر التعليم الرقمي 
</h3>
                ...
                <div id="right-bottom">
                    <div id="right-bottom-circle">
                        <img src="https://i.ibb.co/Kbd0xbp/smart.png" alt="smart"/>
                    </div>

                    <div id="right-bottom-text">
                        <h3> 3). تدريب لخريجي الجامعات العاطلين عن العمل في التخصصات الإنسانية
</h3>
                    </div>
                </div>
                ...
                <div id="left-bottom">
                    <div id="left-bottom-circle">
                        <img src="https://i.ibb.co/G53sbGK/customer.png" alt="customer"/>
                    </div>

                    <div id="left-bottom-text">
                        <h3>4). مساعدة ذوي الإعاقات من خلال توفير خدمات الإرشاد عن بعد 
</h3>
                    </div>
                </div>
            </div>
