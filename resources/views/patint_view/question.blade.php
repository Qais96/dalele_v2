				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<ul class="nav nav-tabs" role="tablist">
								<li class="">
									<a href="#tab1" role="tab" data-toggle="tab" aria-expanded="false">Quality</a>
								</li>
								<li class="">
									<a href="#tab2" role="tab" data-toggle="tab" aria-expanded="false">Comfort</a>
								</li>
								<li class="active">
									<a href="#tab3" role="tab" data-toggle="tab" aria-expanded="true">Results</a>
								</li>
							</ul>
						...
						<div class="col-md-6">
							...
							<ul class="nav-unstyled darklinks" role="tablist">
								<li class="">
									<a href="#tab-unstyled-1" role="tab" data-toggle="tab" aria-expanded="false">Quality</a>
								</li>
								<li class="">
									<a href="#tab-unstyled-2" role="tab" data-toggle="tab" aria-expanded="false">Comfort</a>
								</li>
								<li class="active">
									<a href="#tab-unstyled-3" role="tab" data-toggle="tab" aria-expanded="true">Results</a>
								</li>
							</ul>

							<!-- Tab panes -->
							<div class="tab-content tab-unstyled">
								<div class="tab-pane fade" id="tab-unstyled-1">
									<p>
										Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
									</p>
								...
								<div class="tab-pane fade active in" id="tab-unstyled-3">
									<p>
										Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
									</p>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<ul class="nav nav-tabs" role="tablist">
								<li class="">
									<a href="#tab7" role="tab" data-toggle="tab" aria-expanded="false">Quality</a>
								</li>
								<li class="">
									<a href="#tab8" role="tab" data-toggle="tab" aria-expanded="false">Comfort</a>
								</li>
								<li class="active">
									<a href="#tab9" role="tab" data-toggle="tab" aria-expanded="true">Results</a>
								</li>
							</ul>
							...
							<div class="tab-content">
								...
								<div class="tab-pane fade active in" id="tab9">
									<p class="featured-tab-image">
							...
							<ul class="nav nav-tabs" role="tablist">
								<li class="">
									<a href="#tab4" role="tab" data-toggle="tab" aria-expanded="false">
										<i class="rt-icon2-heart-outline"></i> Quality</a>
								</li>
								<li class="">
									<a href="#tab5" role="tab" data-toggle="tab" aria-expanded="false">
										<i class="fa fa-paw"></i> Comfort</a>
								</li>
								<li class="active">
									<a href="#tab6" role="tab" data-toggle="tab" aria-expanded="true">
										<i class="rt-icon2-star-outline"></i>Results</a>
								</li>
							</ul>
							...
							<div class="row vertical-tabs">
								<div class="col-sm-4">
									...
									<ul class="nav" role="tablist">
										<li class="active">
											<a href="#vertical-tab1" role="tab" data-toggle="tab" aria-expanded="true">
												<i class="rt-icon2-home2"></i> Consectetur
											</a>
										</li>
										<li class="">
											<a href="#vertical-tab2" role="tab" data-toggle="tab" aria-expanded="false">
												<i class="rt-icon2-light-bulb"></i> Eveniet
											</a>
										</li>
										<li class="">
											<a href="#vertical-tab3" role="tab" data-toggle="tab" aria-expanded="false">
												<i class="rt-icon2-book"></i> Dolorum
											</a>
										</li>
										<li class="">
											<a href="#vertical-tab4" role="tab" data-toggle="tab" aria-expanded="false">
						...
						<div class="col-sm-6">
							...
							<div class="panel-group" id="accordion1">
								...
								<div class="panel panel-default">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a data-toggle="collapse" data-parent="#accordion1" href="#collapse4" class="" aria-expanded="true">
												<i class="rt-icon2-bubble highlight"></i>
												Developing
											</a>
										</h4>
						...
						<div class="col-sm-6">
							...
							<div class="panel-group" id="accordion2">
								...
								<div class="panel panel-default collapsed">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a data-toggle="collapse" data-parent="#accordion2" href="#collapse6" class="collapsed" aria-expanded="false">
												Sit Amet
											</a>
										</h4>
									</div>
								...
								<div class="panel panel-default collapsed">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a data-toggle="collapse" data-parent="#accordion2" href="#collapse7" class="collapsed" aria-expanded="false">
												Sed Diam
											</a>
										</h4>
									</div>
								...
								<div class="panel panel-default">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a data-toggle="collapse" data-parent="#accordion2" href="#collapse8" class="" aria-expanded="true">
												Eirmod Tempor
											</a>
										</h4>
									</div>
									<div id="collapse8" class="panel-collapse collapse in" aria-expanded="true" style="">
										<div class="panel-body">
											<div class="media">
												<div class="media-left">
													<a href="#">
						...
						<div class="col-sm-6">
							...
							<div id="accordion3" class="panel-group collapse-unstyled">
								<div class="panel collapsed">
									...
									<h4>
										<a data-toggle="collapse" data-parent="#accordion3" href="#collapse11" aria-expanded="false" class="collapsed">
								...
								<div class="panel">
									<h4>
										<a data-toggle="collapse" data-parent="#accordion3" href="#collapse12" class="collapsed" aria-expanded="false">
								...
								<div class="panel collapsed">
									...
									<h4>
										<a data-toggle="collapse" data-parent="#accordion3" href="#collapse13" class="collapsed" aria-expanded="false">
								...
								<div class="panel collapsed">
									...
									<h4>
										<a data-toggle="collapse" data-parent="#accordion3" href="#collapse14" class="" aria-expanded="true">
											Tempora aspernatur doloribus
										</a>
									</h4>

									<div id="collapse14" class="panel-collapse collapse in" aria-expanded="true" style="">
										<div class="panel-content">
											Lorem ipsum dolor sit amet, consectetur adipisicing elit. At nobis omnis delectus, asperiores quo obcaecati et iste corporis necessitatibus tempora aspernatur doloribus. Ut deleniti commodi dicta distinctio sit enim quidem!
										</div>
