...
@if($viewType == 'sender')
    <div class="message-card mc-sender" title="{{ $fullTime }}" data-id="{{ $id }}">
        ...
        <div class="image-file chat-image" style="margin-top:10px;width: 250px; height: 150px;background-image: url('https://app.daleli.org/storage/attachments/{{$attachment[0]}} ')">
        </div>
        @endif
    </div>
@endif
